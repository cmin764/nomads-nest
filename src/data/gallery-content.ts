...
export const allRooms: GalleryRoom[] = [
  ...
  },
  {
    ...
    images: [
      ...
      { src: base("living-area", "D-living-9b.JPG"), alt: "Sofa and coffee table with afternoon light", width: 2048, height: 1365 },
      { src: base("living-area", "D-living-11.JPG"), alt: "TV unit and living area décor", width: 2048, height: 1366 },
      { src: base("living-area", "D-living-11a.JPG"), alt: "Television and entertainment unit detail", width: 2048, height: 1365 },
      ...
      { src: base("living-area", "CMN01701.JPG"), alt: "TV unit with coral sculpture decoration", width: 1365, height: 2048 },
    ],
  },
  {
    slug: "kitchen",
    ...
    images: [
      ...
      { src: base("kitchen", "D-kitchen-5a.JPG"), alt: "Espresso machine on kitchen shelf", width: 2048, height: 1365 },
      ...
      { src: base("kitchen", "CMN01665.JPG"), alt: "Kitchen appliances and cookware", width: 2048, height: 1366 },
    ],
  },
  {
    slug: "bathroom",
