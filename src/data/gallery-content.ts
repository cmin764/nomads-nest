...
export const allRooms: GalleryRoom[] = [
  {
    ...
    images: [
      ...
      { src: base("terrace", "A-terrace-8.JPG"), alt: "Wide terrace view with wooden furniture" },
  ...
  },
  {
    ...
    images: [
      ...
      { src: base("bedroom", "B-bedroom-3.JPG"), alt: "Bedroom window with natural light" },
      ...
      { src: base("bedroom", "B-bedroom-6.JPG"), alt: "Made bed with blue accent pillows" },
      { src: base("bedroom", "B-bedroom-7.JPG"), alt: "Bedroom work desk with ergonomic chair" },
      { src: base("bedroom", "B-bedroom-8.JPG"), alt: "Bedroom with mirror and natural light" },
      { src: base("bedroom", "B-bedroom-8a.JPG"), alt: "Bedside table and reading lamp detail" },
  ...
  },
  {
    ...
    images: [
      ...
      { src: base("kitchen", "D-kitchen-7.JPG"), alt: "Shelf with espresso machine and tea collection" },
