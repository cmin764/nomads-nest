...
export const landmarks: Landmark[] = [
  ...
  // ── Sights & Experiences ──
  {
    ...
    category: "sight",
    image: { src: base("bridge-of-love.jpg"), alt: "Natural limestone sea arch over turquoise water at sunset" },
  ...
  },
  {
    ...
    category: "sight",
    image: { src: base("ayia-napa-square.jpg"), alt: "I Love Ayia Napa stone letter sculpture in the town square" },
